...
/**
 * shellby_env - a fun that prints the current environment
...
/**
 * shellby_setenv - a fun that changes or adds an environmental variable
 * to the PATH
 * @args: the array of arguments passed to the shell
 * @front: the double pointer to the beginning of args
...
/**
 * shellby_unsetenv - a fun that deletes an environmental variable from
 * the PATH
 * @args: the array of arguments passed to the shell
 * @front: the double pointer to the beginning of args
