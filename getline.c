...
/**
 * _realloc - a fun that reallocates a memory block using malloc and free
...
/**
 * assign_lineptr - a fun reassigns the lineptr variable for _getline
...
/**
 * _getline - a fun reads input from a stream
