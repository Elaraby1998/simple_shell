...
/**
 * help_all - a fun that displays all possible builtin shellby commands
 */
...
/**
 * help_alias - a fun that displays information on the shellby builtin
 * command'alias'
 */
...
/**
 * help_cd - a fun that displays information on the shellby builtin
 * command 'cd'
 */
...
/**
 * help_exit - a fun that displays information on the shellby builtin
 * command 'exit'
 */
...
/**
 * help_help - a fun that displays information on the shellby builtin
 * command 'help'
 */
